...
function testNoCalls() {
  var f = goog.testing.recordFunction(goog.listenerObjects.identity);
...
function testWithIdentityFunction() {
  ...
  assertEquals('original function', goog.listenerObjects.identity,
...
function testWithErrorFunction() {
  var f = goog.testing.recordFunction(goog.listenerObjects.error('error'));
