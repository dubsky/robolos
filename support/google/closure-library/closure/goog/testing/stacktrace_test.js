...
function testGetStackFrameWithV8CallSites() {
  ...
  function createCallSite(functionName, fileName, lineNumber, colNumber) {
    return {
      getFunctionName: goog.listenerObjects.constant(functionName),
      getFileName: goog.listenerObjects.constant(fileName),
      getLineNumber: goog.listenerObjects.constant(lineNumber),
      getColumnNumber: goog.listenerObjects.constant(colNumber)
    };
  }
