 ...
 */
goog.editor.Field.prototype.usesIframe = goog.listenerObjects.TRUE;
 ...
 */
goog.editor.Field.prototype.isFixedHeight = goog.listenerObjects.TRUE;
...
goog.editor.Field.prototype.setupChangeListeners_ = function() {
  ...
  if (goog.editor.BrowserFeature.USE_MUTATION_EVENTS) {
    ...
    this.addListener(['cut', 'paste'],
        goog.listenerObjects.lock(this.dispatchChange));
