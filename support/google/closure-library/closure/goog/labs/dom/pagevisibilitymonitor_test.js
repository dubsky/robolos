...
function testNoVisibilitySupport() {
  stubs.set(goog.labs.dom.PageVisibilityMonitor.prototype,
      'getBrowserEventType_', goog.listenerObjects.NULL);
...
function testListener() {
  stubs.set(goog.labs.dom.PageVisibilityMonitor.prototype,
      'getBrowserEventType_', goog.listenerObjects.constant('visibilitychange'));
...
function testListenerForWebKit() {
  stubs.set(goog.labs.dom.PageVisibilityMonitor.prototype,
      ...
      goog.listenerObjects.constant('webkitvisibilitychange'));
