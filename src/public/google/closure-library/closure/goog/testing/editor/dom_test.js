...
function createFakeRange(startNode, startOffset, opt_endNode, opt_endOffset) {
  ...
  return {
    getStartNode: goog.listenerObjects.constant(startNode),
    getStartOffset: goog.listenerObjects.constant(startOffset),
    getEndNode: goog.listenerObjects.constant(opt_endNode),
    getEndOffset: goog.listenerObjects.constant(opt_endOffset)
  };
}
