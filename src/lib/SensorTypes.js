SensorTypes={
    ...
    S_WIND: { id:'S_WIND', comment:'Wind sensor', class: SensorClasses.FLOAT},
    S_RAIN: { id:'S_RAIN', comment:'Rain sensor', class: SensorClasses.FLOAT},
    S_UV: { id:'S_UV', comment:'UV sensor', class: SensorClasses.FLOAT},
